...
Setelah itu visualisasikan dengan mouse.py maka muncul flag part 2: `mouse_ngasih_click_keputusan}`
...
Setelah itu visualisasikan dengan keyboard.py maka muncul sebuah log VIM yang kemudian bisa di decode dengan referensi [https://vim.rtorr.com/](https://vim.rtorr.com/) maka muncul flag part 1: `ITFEST25{keyboard_ngasih_clue_kehidupan_`
